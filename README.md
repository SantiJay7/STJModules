...
### Balatube (`Balatube`)
Physically-modeled percussion voice: MATERIAL sweeps from an ebony balafon / marimba bar (wood) to a closed-pipe PVC tube (odd harmonics 1:3:5…). Six-mode modal resonator, jet flanger, overdrive/crunch, full per-knob CV, stereo external-audio bus.
