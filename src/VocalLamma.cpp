...
struct VocalLammaTextLabel : Widget {
	std::string text;
	float fontSize;
	NVGcolor color;

	VocalLammaTextLabel(std::string t, float fs, NVGcolor c) : text(t), fontSize(fs), color(c) {}
...
struct VocalLammaLogoWidget : Widget {
...
struct VocalLammaWidget : ModuleWidget {
	VocalLammaWidget(VocalLamma* module) {
		...
		{
			VocalLammaLogoWidget* logo = new VocalLammaLogoWidget;
		...
		// intricate hand-drawn interior pattern survives (raster, via VocalLammaLogoWidget).
		{
		...
		{
			VocalLammaLogoWidget* sym = new VocalLammaLogoWidget;
	...
	void addLabel(const std::string& text, math::Vec posMm, float fontSize, NVGcolor color) {
		VocalLammaTextLabel* label = new VocalLammaTextLabel(text, fontSize, color);
